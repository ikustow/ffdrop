...
abstract class FlutterFlowTheme {
  ...
  late Color mainPageBackground;
  late Color navBar;
  late Color tokenPageBackground;
  late Color accountPageBackground;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF5C6BC0);
  late Color secondary = const Color(0xFFFF7043);
  late Color tertiary = const Color(0xFF4DD0E1);
  late Color alternate = const Color(0xFFFFD54F);
  ...
  late Color accent1 = const Color(0xFF8BC34A);
  late Color accent2 = const Color(0xFFFF9800);
  ...
  late Color mainPageBackground = Color(0xFFFDFD96);
  late Color navBar = Color(0xFFFFCCDD);
  late Color tokenPageBackground = Color(0xFFDAF5F0);
  late Color accountPageBackground = Color(0xFFBAFCA2);
}
